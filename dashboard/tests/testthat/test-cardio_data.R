...
test_that("c4c_year_delta computes year_start minus year_end per groep (a decrease over time is positive)", {
  df <- make_test_outcomes()
  ...
  expect_equal(out$waarde, 140000 / 900000 * 100 - 143760 / 915280 * 100)
})
